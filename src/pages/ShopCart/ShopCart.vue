        ...
        >
          ...
          <li class="cart-list-con1">
            <input
              ...
              @click="changeChecked(cartInfo, $event)"
            />
          </li>
          <!-- 图片，标题 -->
          ...
          <li class="cart-list-con5">
            <a class="mins" @click="handlerNum('minus', -1, cartInfo)">-</a>
            <input
              autocomplete="off"
              type="text"
              minnum="1"
              ...
              @change="handlerNum('change', $event.target.value * 1, cartInfo)"
            />
            <a
              href="javascript:void(0)"
              class="plus"
              @click="handlerNum('add', 1, cartInfo)"
              >+</a
            >
          </li>
          <!-- 商品总价 -->
...
export default {
  ...
  methods: {
    ...
    // 商品数量增减
    async handlerNum(type, disNum, cartInfo) {
      switch (type) {
        case "add":
          disNum = 1;
          break;
    ...
    async allChecked(event) {
      try {
        ...
        await this.$store.dispatch("shopcart/allChecked", allChecked);
        this.getData();
      } catch (error) {
        alert(error.message);
      }
